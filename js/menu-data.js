...
const MENU_DATA = [
  // 1. CAFÉ ---------------------------------------------------------------
  {
    ...
    items: [
      ...
      { id: "cafe-02", name: { es: "Cortado", en: "Cortado", pt: "Cortado" }, price: { es: "P Gs. 16.000 · M Gs. 19.000", en: "S Gs. 16.000 · M Gs. 19.000", pt: "P Gs. 16.000 · M Gs. 19.000" } },
      { id: "cafe-03", name: { es: "Café con leche", en: "Coffee with milk", pt: "Café com leite" }, price: { es: "M Gs. 20.000 · G Gs. 25.000", en: "M Gs. 20.000 · L Gs. 25.000", pt: "M Gs. 20.000 · G Gs. 25.000" } },
  ...
  // 2. COCIDO QUEMADO -------------------------------------------------------
  {
    ...
    items: [
      ...
      { id: "cocido-02", name: { es: "Cocido negro", en: "Black cocido", pt: "Cocido preto" }, price: { es: "M Gs. 15.000 · G Gs. 18.000", en: "M Gs. 15.000 · L Gs. 18.000", pt: "M Gs. 15.000 · G Gs. 18.000" } },
      { id: "cocido-03", name: { es: "Cocido con leche", en: "Cocido with milk", pt: "Cocido com leite" }, price: { es: "M Gs. 16.000 · G Gs. 19.000", en: "M Gs. 16.000 · L Gs. 19.000", pt: "M Gs. 16.000 · G Gs. 19.000" } }
    ]
  },
  ...
  // 3. CHOCOLATES -----------------------------------------------------------
  {
    ...
    items: [
      { id: "choco-01", name: { es: "Chocolate caliente", en: "Hot chocolate", pt: "Chocolate quente" }, desc: { es: "De la olla a la taza, endulzado con leche condensada.", en: "Straight from the pot to the cup, sweetened with condensed milk.", pt: "Direto da panela para a xícara, adoçado com leite condensado." }, price: { es: "M Gs. 25.000 · G Gs. 35.000", en: "M Gs. 25.000 · L Gs. 35.000", pt: "M Gs. 25.000 · G Gs. 35.000" } },
